...
Par exemple, 
Au début, notre arbre ressemble à ça : [picture]

Ensuite, on insère le mot *art*, on a alors l'arborescence suivante :[picture]

on insère chine :[picture]

on insère chien : [picture]
